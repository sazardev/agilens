      ...
      >
        ...
        <div style={card}>
          ...
          {activeSprint && !showSprintForm && (
            ...
            >
              <span
                style={{ fontSize: '11px', color: 'var(--text-3)', fontFamily: 'var(--font-mono)' }}
              >
            ...
            >
              {sprintNotes.length > 0 && (
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                    {sprintNotes.slice(0, 5).map(note => (
                      <NoteCheckRow
                        key={note.id}
                        note={note}
              ...
              >
                {filteredNotes.length === 0 && (
                  <p style={{ fontSize: '12px', color: 'var(--text-3)', margin: 0 }}>Sin notas</p>
                )}
